...
- `Camera:` is one of the most versatile sensors for the self-driving car
- Cameras act as the eyes of the self-driving car. The cars use cameras to detect agents on the road, model their movement, and model their behaviors. 
...
### Lab•. Duration: 2 hours2h
### (Submission) Applying Stereo Depth to a Driving Scenario
### Practice Programming Assignment•. Duration: 1 hour 30 minutes1h 30m
